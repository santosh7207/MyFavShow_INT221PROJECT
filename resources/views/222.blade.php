...
<style type="text/css">
  ...
  <ul class="lis">
    <li>Director: Ruben Fleischer</li>
    <li>Actors: Tom Hardy, Michelle Williams, Riz Ahmed, Scott Haze, Reid Scott, Jenny Slate, Melora Walters, Woody Harrelson, Peggy Lu, Malcolm C. Murray, Sope Aluko, Wayne Pére, Michelle Lee, Kurt Yue, Chris O'Hara</li>
    <li>Release Date: 2018-10-05</li>
    <li>Genres: Action, Sci-Fi</li>
    <li>Genres: Action, Sci-Fi</li>
  </ul>
  </dir>
  <div class="sub">
